    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center space-x-6">
              <Link href="/expert-dashboard" className="text-gray-600 hover:text-purple-600">Dashboard</Link>
              <Link href="/expert-dashboard/articles" className="text-gray-600 hover:text-purple-600">Articles</Link>
              <Link href="/expert-dashboard/chat" className="text-purple-600 font-medium">Messages</Link>
            </nav>
            <div className="flex items-center space-x-4">
              ...
              <Link href="/expert-dashboard/profile">
                <Avatar className="h-8 w-8 cursor-pointer">
                  <AvatarImage src="" />
                  <AvatarFallback className="bg-purple-100 text-purple-700">ED</AvatarFallback>
                </Avatar>
              </Link>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Provide expert advice to farmers and buyers</p>
        </div>
              ...
              <ScrollArea className="h-full">
                {isLoading ? (
                  ...
                  filteredConversations.map((conv) => {
                    ...
                    const roleColor = other.role === 'FARMER' ? 'text-green-600' : 'text-blue-600'
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 border-b cursor-pointer hover:bg-gray-50 transition-colors ${
                          selectedConversation === conv.id ? 'bg-purple-50 border-l-4 border-l-purple-500' : ''
                        }`}
                      >
                        <div className="flex items-start space-x-3">
                          <div className="relative">
                            <Avatar className="h-12 w-12">
                              ...
                              <AvatarFallback className={other.role === 'FARMER' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className={`text-sm truncate capitalize ${roleColor}`}>{other.role.toLowerCase()}</p>
                            <p className="text-sm text-gray-500 truncate">{getLastMessage(conv)}</p>
                          </div>
                          {getUnreadCount(conv) > 0 && (
                            <Badge className="bg-purple-600">{getUnreadCount(conv)}</Badge>
                          )}
                        </div>
                      </div>
                    )
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="relative">
                        <Avatar className="h-10 w-10">
                          ...
                          <AvatarFallback className={otherParticipant.role === 'FARMER' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'}>
